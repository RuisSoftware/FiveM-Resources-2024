...
RegisterServerEvent('esx_poolcleanersecondary:GiveItem')
AddEventHandler('esx_poolcleanersecondary:GiveItem', function()
	...
	if Quantity >= 20 then
		...
		TriggerClientEvent('esx:showNotification', _source, 'Je ontving ~g~x' .. amount .. ' ontvangen')
	end
	...
	SetTimeout(Config.Zones.Vente.ItemTime, function()
		...
		if PlayersVente[source] == true then
			...
			if Quantity < Config.Zones.Vente.ItemRemove then
				TriggerClientEvent('esx:showNotification', _source, '~r~Je hebt geen '..Config.Zones.Vente.ItemRequires_name..' om te verzilveren.')
...
RegisterServerEvent('esx_poolcleanersecondary:startVente')
AddEventHandler('esx_poolcleanersecondary:startVente', function()
...
RegisterServerEvent('esx_poolcleanersecondary:stopVente')
AddEventHandler('esx_poolcleanersecondary:stopVente', function()
