...
if cancel then
  ...
  TriggerServerEvent('esx_gardenersecondary:GiveItem')
  StartNPCJob()
  Done = true
end
end
...
AddEventHandler('esx_gardenersecondary:hasEnteredMarker', function(zone)
...
AddEventHandler('esx_gardenersecondary:hasExitedMarker', function(zone)

if zone == 'Vente' then
TriggerServerEvent('esx_gardenersecondary:stopVente')
end
CurrentAction = nil
ESX.UI.Menu.CloseAll()
end)
...
TriggerEvent('esx_gardenersecondary:hasEnteredMarker', currentZone)
end
if not isInMarker and HasAlreadyEnteredMarker then
HasAlreadyEnteredMarker = false
TriggerEvent('esx_gardenersecondary:hasExitedMarker', LastZone)
end
end
end
end)
...
TriggerServerEvent('esx_gardenersecondary:startVente')
end
