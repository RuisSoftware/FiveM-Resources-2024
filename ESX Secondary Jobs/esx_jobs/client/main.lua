		...
		if jobObject then
			for k,v in pairs(jobObject.Zones) do
				...
				if v.Blip then
					...
					exports['DP_Blip_Info']:SetBlipInfoTitle(blip, "Vaste baan", rockstarVerified)
					exports['DP_Blip_Info']:AddBlipInfoName(blip, v.Name, "")
					exports['DP_Blip_Info']:AddBlipInfoHeader(blip, "Gradatie:", PlayerData.job.grade_label)
					exports['DP_Blip_Info']:SetBlipInfoImage(blip, "world_blips", "supermarkt")
					exports['DP_Blip_Info']:AddBlipInfoText(blip, "Dit is je vaste baan", "")
